          ...
          {!isSubmitted ? (
            <>
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-gray-500 text-sm leading-relaxed">
                  The ultimate peer-to-peer marketplace is launching soon on
                  desktop.
                  <br />
                  <span className="font-semibold text-gray-700">
                    Sell faster. Buy smarter. Zero hidden fees.
                  </span>
                </p>
              </div>
            ...
            <div className="text-center py-4 animate-in fade-in slide-in-from-bottom-4">
              ...
              <p className="text-gray-500 text-sm mb-6">
                ...
                <span className="font-semibold text-gray-800">{email}</span> the
                moment we launch.
              </p>
              <button
                onClick={resetForm}
