...
import cgProperty from "../assets/images/cg_property.png";
import cgHomeAndFurniture from "../assets/images/cg_home_and_furniture.png";
import cgBabiesAndKids from "../assets/images/cg_babies_and_kids.png";
import cgVehiclesAndAccessories from "../assets/images/cg_vehicles_and_accessories.png";
import cgMachineryAndConstruction from "../assets/images/cg_machinery_and_construction.png";
import cgOthers from "../assets/images/cg_others.png";
...
export const categoryImageMap: ImageMap[] = [
    ...
    {tag: "cg_property", location: cgProperty},
    {tag: "cg_home_and_furniture" , location: cgHomeAndFurniture},
    {tag: "cg_babies_and_kids" , location: cgBabiesAndKids},
    {tag: "cg_vehicles_and_accessories", location: cgVehiclesAndAccessories},
    {tag: "cg_machinery_and_construction", location: cgMachineryAndConstruction},
    {tag: "cg_others", location: cgOthers},
];